        ...
        <div class="container-fluid">
            <div class="card card-default ">
                <div class="card-header newHead">
                    <h3 class="card-title text-bold">Update Site Survey </h3>
                </div>

                <form action="{{route('update-site-survey')}}" method="post"   enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="location" id="location" class="form-control" value="{{$site->location}}">
                            </div> -->
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" min="1" name="latitude"  class="form-control" list="Initial Latitude" value="{{$site->latitude}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="land_coverage" id="Land Coverage(sq m)" class="form-control" list="Land Coverage(sq m)" value="{{$site->land_coverage}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="water_depth" id="Water Depth Level(ft) " class="form-control" list="Water Depth Level(ft) " value="{{$site->water_depth}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="imei" id="IMEI" class="form-control" list=" IMEI " value="{{$site->imei}}">
                                <datalist id=" IMEI	 ">
                                    <option value=""></option>
                                </datalist>
                            </div>
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="pump_no" id="PumpSerialNo " class="form-control" list="PumpSerialNo " value="{{$site->pump_no}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="pump_controller_no" id="PumpControllerSerialNo" class="form-control" list="PumpControllerSerialNo" value="{{$site->pump_controller_no}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="solar_panel_no" id="SolarPanelSerialNo" class="form-control" list="SolarPanelSerialNo" value="{{$site->solar_panel_no}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="family_id" id="Family ID" class="form-control" list="Family ID" value="{{$site->family_id}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="controller_type" id="Controller Type" class="form-control" list="Controller Type" value="{{$site->controller_type}}">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="old_app" id="Old ApplicationNo" class="form-control" list="Old ApplicationNo" value="{{$site->old_app}}">
